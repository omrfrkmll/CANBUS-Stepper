...
<p align="center">
  <b>ESP32-S3 Based Closed-Loop Smart CAN Bus Stepper Motor Driver Board (v1.1)</b>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Schematic-PDF%20v1.1-red?style=for-the-badge&logo=adobeacrobatreader&logoColor=white" alt="Schematic PDF"/>
...
<p align="center">
  ...
  <br>
  <i>Figure 1: CANBUS-Stepper v1.1 Component Layout — Top Layer (Left) & Bottom Layer (Right)</i>
</p>
...
1. **Schematic Circuit Diagrams (PDF)**:
   - Complete multi-sheet reference schematics are available in [`docs/schematics/CANBUS_Stepper_v1.1_Schematic.pdf`](docs/schematics/CANBUS_Stepper_v1.1_Schematic.pdf) (Legacy v1.0 available in [`docs/schematics/`](docs/schematics/)).
...
2. **3D Mechanical STEP Assembly**:
   - Ready-to-import 3D CAD model: [`step/canbus-stepper-v1.1.step`](step/canbus-stepper-v1.1.step).
...
│       └── CANBUS_Stepper_v1.1_Schematic.pdf
...
└── step/                          # 3D CAD STEP Files for mechanical integration
    ├── canbus-stepper-v1.1.step   # Full 3D PCB assembly STEP model (v1.1)
